/**
 * File: httpClient.js
 * Chức năng: Cấu hình trung tâm cho các request gọi API (BaseURL, Header). Mọi service gọi API đều đi qua đây.
 * Được dùng trong: Tất cả các file trong thư mục core_modules/api/ (authApi, productApi, categoryApi, postApi, v.v...)
 */
